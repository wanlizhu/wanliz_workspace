...
if [[ $ans == yes ]]; then
    ...
    if [[ -z $(openconnect --version | head -1 | grep "v9") ]]; then
        ...
        if [[ ! -z $(lsb_release -r | grep "22") ]]; then
            wget --no-check-certificate https://download.opensuse.org/repositories/home:/bluca:/openconnect/Ubuntu_22.04/amd64/openconnect_9.12+201+gf17fe20-0+283.1_amd64.deb
            sudo dpkg -i openconnect_9.12+201+gf17fe20-0+283.1_amd64.deb
        elif [[ ! -z $(lsb_release -r | grep "24") ]]; then
            wget --no-check-certificate https://download.opensuse.org/repositories/home:/bluca:/openconnect/Ubuntu_24.04/amd64/openconnect_9.12+201+gf17fe20-0+283.1_amd64.deb
            sudo dpkg -i openconnect_9.12+201+gf17fe20-0+283.1_amd64.deb
        else
